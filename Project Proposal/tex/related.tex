...
\begin{figure}
	\begin{subfigure}{1\textwidth}
		...
		\label{fig:GPM1}
		\subcaption{Documents view: screen after a search term has been entered. The main component of the page is the list of relevant documents, ordered by latest publication date. Additional filters are available in the sidebar to the right. }
	\end{subfigure}\\
	\par\bigskip
	\begin{subfigure}{1\textwidth}
...
\begin{figure}
	\begin{subfigure}{1\textwidth}
		...
		\label{fig:VV1}
		\subcaption{Terms map generated from a PubMed dataset of 1042 citations with 'IDH1' and 'cancer' searched in all fields\footnotemark[2]. Nodes are coloured by term type, sized by occurrence and clustered by co-occurrence. These features are customisable as can be seen from the panes on each side.}
	\end{subfigure}
	\par\bigskip
	\begin{subfigure}{1\textwidth}
		\includegraphics[width=\textwidth]{../lib/images/VV2}
		\label{fig:VV2}
		\subcaption{Authors map generated from a PubMed dataset of 2895 citations with 'Alzheimer's Disease' in the MeSH terms, published since January 1st 2014\footnotemark[2]. Node colourings, clusters and lines are determined by co-citations.}
	\end{subfigure} 
\caption{Network maps created using VOSviewer.}
\footnotetext[2]{Query ran 08/04/15.}
\end{figure}
